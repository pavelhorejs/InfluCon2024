...
const Agenda = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-2" id="agenda">
      ...
      <Revealx delay={0.4}>
        {" "}
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-y-10 bg-[#F00065] hover:bg-[#D6005A] py-9 px-9 redGlow redCard2">
          <div className="redItem3"></div>
          <div className="redItem4"></div>

          <div className="">
            <h3 className="text-4xl font-bold pb-5">13:45-14:45</h3>
            {t("programBlock4")} <br />
          </div>
          <div className="">
            <h3 className="text-4xl font-bold pb-5">14:45-16:20</h3>
            {t("programBlock4_1")}
          </div>
          <div className="">
            <h3 className="text-4xl font-bold pb-5">16:20-18:00</h3>
            <p className="">{t("programBlock5")}</p>
          </div>
          <div className="">
            <h3 className="text-4xl font-bold pb-5">20:00</h3>
