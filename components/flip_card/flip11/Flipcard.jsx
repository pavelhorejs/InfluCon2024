    ...
    <div>
        ...
        frontComponent={
          <div style={contentStyle}>
            <Image
              width={300}
              height={300}
              src={i18n.language === "en" ? "/Niko_en.webp" : "/Niko_cz.webp"}
              alt="Front Image"
              style={contentStyle}
            />
          </div>
      ...
      <div className="flex flex-col justify-between max-w-[300px]">
        <div className="flex justify-between items-center">
          {" "}
          <p className={style.name}>Nikoloz Bolkvadze</p>
          <Link href="https://www.linkedin.com/in/nikolozbolkvadze/">
            <img src="/in_black.svg" className="w-5" alt="" />
          </Link>
        </div>
        <p className={style.company}>Client Partner, Meta</p>
      </div>
    </div>
  );
};
